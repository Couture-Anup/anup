  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-16 md:py-32">
      ...
      <div className="text-center max-w-3xl mx-auto mb-20">
        <h1 className="text-3xl md:text-5xl font-serif uppercase tracking-[0.05em] mb-6">
          Contact Us
        </h1>

        <p className="text-gray-600 font-light leading-relaxed text-lg">
          For inquiries about our collections, bespoke services, or retail
          partnerships, please reach out directly via the information below.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 md:gap-16">
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 space-y-2">
            ...
            <a
              id="india-manufacturing-call"
              href="tel:+919625981155"
              data-gtm-event="india_phone_call"
              className="text-gray-600 font-light hover:text-black transition-colors block"
            >
              +91 96259 81155
            </a>
          </div>
      ...
      <div className="mt-20 pt-12 border-t border-gray-200 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-start">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-2">
            <h2 className="text-sm font-semibold tracking-widest uppercase text-gray-900 border-b border-gray-200 pb-4 mb-4">
              Email Us
            </h2>

            <a
              href="mailto:info@anupguptastudio.com"
              className="text-gray-600 font-light hover:text-black transition-colors block"
            >
