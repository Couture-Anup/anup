...
const FALLBACK_NEW_DROPS = [
  ...
  {
    title: "Conquerer(Globe) - Hand Embroidered Designer Shirt",
    price: 8900,
    seed: "globe",
  },
  {
    title: "Cobweb(Spider) - Hand Embroidered Designer Shirt",
    price: 7250,
    seed: "spider",
  },
  {
    title: "Ember - Hand Embroidered Designer Shirt",
    price: 5750,
    seed: "ember",
  },
  {
    title: "Zodiac Signs - Hand Embroidered Designer Shirt",
    price: 8900,
    seed: "zodiac",
  },
];
...
const FALLBACK_BESTSELLERS = [
  {
    title: "The Champagne Shirt - Black",
    price: 5200,
    seed: "champagne",
  },
  {
    title: "Leopard/Animal Print - Handcrafted Designer Shirt",
    price: 7650,
    seed: "leopard",
  },
  {
    title: "Drizzle Metal (Chain) Hand Embroidered Designer Shirt",
    price: 5750,
    seed: "drizzle",
  },
  {
    title: "Parrot hand embroidered designer shirt - Black",
    price: 8900,
    seed: "parrot",
    originalPrice: 9000,
  },
  {
    title: "Scorpion Hand Embroidered Designer Shirt",
    price: 8900,
    seed: "scorpion",
  },
];
...
const mapProduct = (product: any) => ({
  ...
  imageUrl:
    product.imageUrl ||
    (product.seed
      ? `https://picsum.photos/seed/${product.seed}/600/800`
      : undefined),

  hoverImageUrl:
    product.hoverImageUrl ||
    (product.seed
      ? `https://picsum.photos/seed/${product.seed}_hover/600/800`
      : undefined),
...
async function HomeContent() {
  ...
  const [
    ...
    client
      .fetch(NEW_ARRIVALS_QUERY)
      .catch(() => []),

    client
      .fetch(BESTSELLERS_QUERY)
      .catch(() => []),

    client
      .fetch(FEATURED_SECTIONS_QUERY)
      .catch(() => []),

    client
      .fetch(CELEBRITIES_QUERY)
      .catch(() => []),

    client
      .fetch(GLOBAL_SETTINGS_QUERY)
      .catch(() => null),
  ]);
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-[#f5f5f5] mb-3">
                  ...
                  <Image
                    src={
                      celeb.imageUrl ||
                      `https://picsum.photos/seed/${celeb.seed}/600/800`
                    }
                    alt={celeb.name}
                    fill
                ...
                >
                  ...
                  <div className="relative aspect-[3/4] mb-4 overflow-hidden bg-gray-100">
                    ...
                    <Image
                      src={
                        cat.imageUrl ||
                        `https://picsum.photos/seed/${cat.seed}/600/800`
                      }
                      alt={cat.title}
                      fill
                      sizes="
              ...
              (_, i) => {
                ...
                return (
                  <Suspense
                    key={i}
                    fallback={
                      <div className="aspect-[170/302] bg-gray-100 animate-pulse" />
                    }
                  >
                    <InstagramPost
                      url={link}
