...
export function ProductForm({
  ...
  /* ======================================================
     ...
     ACCESSORY:
     No size selected / required.
     
     CLOTHING:
     First available size OR Custom Tailored.
  ====================================================== */

  const defaultSize = product.isAccessory
    ? ''
    : product.sizes?.find(
        (size) => size.stock > 0
  ...
  const displayPrice =
    selectedStyle?.price || product.price;
  ...
  const [showStickyBar, setShowStickyBar] =
    useState(false);
  ...
  /* ======================================================
     PRODUCT DETAILS FOR STICKY BAR
  ====================================================== */
  ...
  const handleAddToCart = (
    ...
    /* Custom tailoring validation only
       for NON-ACCESSORY products */
    ...
    if (
      ...
      if (missing) {
        toast(
          `Please enter your measurement for: ${missing[0]}`,
          'warning'
        );
    ...
    addItem(
      {
        ...
        /*
         * Accessories do not require size
         */
        size: product.isAccessory
          ? ''
          : selectedSize,
  ...
  return (
    <>
      ...
      {/* ==================================================
          ...
          COMPLETELY HIDDEN FOR ACCESSORIES
      ================================================== */}
        ...
        <div className="mb-4">
          ...
          {selectedSize ===
            ...
            <div className="mt-6 mb-6 p-5 bg-[#fcfcfc] border border-gray-200 animate-in fade-in slide-in-from-top-2 duration-300">
              <h4 className="text-[13px] font-semibold tracking-wide text-gray-900 mb-4">
                Enter Your
                Measurements
                (inches/cm)
              </h4>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <div className="flex gap-3 h-[46px]">
          ...
          <div className="flex items-center border border-gray-200 w-24 shrink-0 bg-white">
            ...
            <span
              suppressHydrationWarning
              className="flex-1 text-center font-medium text-[13px] text-gray-700"
            >
              {quantity}
            </span>
      ...
      {mounted &&
        createPortal(
          <div
            className={`fixed bottom-4 left-1/2 -translate-x-1/2 w-[95%] max-w-3xl bg-white border border-gray-200 p-2 shadow-2xl z-[9999] transition-all duration-300 hidden md:flex items-center justify-between ${
              showStickyBar
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:block">
                <p className="text-[13px] font-semibold text-gray-900 truncate max-w-[200px] md:max-w-xs">
                  {
                    product.title
                  }
                </p>
